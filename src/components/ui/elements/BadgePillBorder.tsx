...
interface BadgePillBorderProps {
    /** Badge text */
    label?: string
    /** Color variant */
    color?: BadgeColor
...
export default function BadgePillBorder({
    label = 'Badge',
    color = 'gray',
}: BadgePillBorderProps) {
    return (
        <span
            className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium ring-1 ring-inset ${colorClasses[color]}`}
        >
            {label}
        </span>
    )
