...
interface SectionHeadingActionsTabsProps {
    title: string;
    tabs: Tab[];
    actionLabel?: string;
    onAction?: () => void;
...
export default function SectionHeadingActionsTabs({
    title,
    tabs: initialTabs,
    actionLabel = 'Create',
    onAction,
    onTabChange,
}: SectionHeadingActionsTabsProps) {
    ...
    return (
        <div className="border-b border-gray-200 dark:border-gray-700 pb-5 sm:pb-0">
            ...
            <div className="mt-3 sm:hidden">
                <label htmlFor="current-tab-actions" className="sr-only">
                    Select a tab
                </label>
                <select
                    id="current-tab-actions"
                    name="current-tab-actions"
