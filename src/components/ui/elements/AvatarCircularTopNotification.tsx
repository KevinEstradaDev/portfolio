...
interface AvatarCircularTopNotificationProps {
    /** Image source URL */
    src?: string
    /** Alt text */
    alt?: string
...
export default function AvatarCircularTopNotification({
    src = 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    alt = '',
    size = 'md',
    notificationColor = 'green',
}: AvatarCircularTopNotificationProps) {
    return (
        <span className="relative inline-block">
            ...
            />
            <span
                className={`absolute right-0 top-0 block ${dotSizeClasses[size]} rounded-full ${dotColorClasses[notificationColor]} ring-2 ring-white dark:ring-gray-900`}
            />
        </span>
    )
}
