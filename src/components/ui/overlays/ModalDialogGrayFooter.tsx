...
interface ModalDialogGrayFooterProps {
    /** Whether the dialog is open */
    open?: boolean
    /** Callback when the dialog should close */
    onClose?: () => void
    /** Icon component rendered in the top-left area */
...
export default function ModalDialogGrayFooter({
    open: controlledOpen,
    onClose,
    icon,
