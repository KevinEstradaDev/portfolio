...
interface NarrowSidebarHeaderLayoutProps {
    navigation: NavItem[];
...
export default function NarrowSidebarHeaderLayout({
    navigation: initialNavigation,
    userNavigation,
    user,
    children,
}: NarrowSidebarHeaderLayoutProps) {
                    ...
                    <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                        ...
                        <form action="#" method="GET" className="grid w-full grid-cols-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    type="search"
                                    placeholder="Search..."
                                    className="block size-full pl-8 pr-0 text-gray-900 dark:text-white bg-transparent border-0 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-0 sm:text-sm"
                                />
                            </div>
                        </form>
                        ...
                        <div className="flex items-center gap-x-4 lg:gap-x-6">
                            ...
                            <Menu as="div" className="relative">
                                ...
                                <MenuItems
                                    transition
                                    className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white dark:bg-gray-800 py-2 ring-1 shadow-lg ring-black/5 dark:ring-white/10 transition focus:outline-hidden data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                                >
                                    {userNavigation.map((item) => (
                                        <MenuItem key={item.name}>
                                            <a
                                                href={item.href}
                                                className="block px-3 py-1 text-sm/6 text-gray-900 dark:text-gray-200 data-focus:bg-gray-50 dark:data-focus:bg-gray-700 data-focus:outline-hidden"
                                            >
                                                {item.name}
                                            </a>
                                        </MenuItem>
